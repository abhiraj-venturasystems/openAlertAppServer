...
//if any error showing related aws sdk, then check the versions with multer-s3
//if you are using v2 of aws-sdk, use version 2.x.x of multer-s3, and for v3 of aws-sdk, use 3.x.x of multer-s3.
...
export const shopImgUpload = multer({
  fileFilter,
  storage: multerS3({
    s3: s3,
